require([
    ...
    */
    ...
    async function simpleGet4326(){
        let result = await fetch("/api/simpleCoords4326");
        coordsArray4326 = await result.json();
        console.log(coordsArray4326.coords4326.length)
        console.log(coordsArray4326.coords4326[0])
        simpleRenderGraphics();
    }

    function simpleRenderGraphics(){
        for(let i = 0; i < coordsArray4326.coords4326.length; i++){

            var polyline = {
                type: "polyline",  // autocasts as new Polyline()
                paths: coordsArray4326.coords4326[i]
            };
